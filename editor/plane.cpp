...
try:
	image(core::Core::getDrawManager()->getImage(confFile.getString(sectionName,"image","").c_str()))
{
...
void Plane::draw(int x, int y, int currentFrame, int direction)
{
	image.draw(x + offsetX,y + offsetY,currentFrame * mWidth,direction*mHeight, mWidth, mHeight);
}
